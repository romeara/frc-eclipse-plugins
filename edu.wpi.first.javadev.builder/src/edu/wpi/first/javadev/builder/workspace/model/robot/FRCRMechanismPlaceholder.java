...
public class FRCRMechanismPlaceholder extends FRCRMechanism{
	protected FRCRMechanismPlaceholder(){super();}
	
	protected FRCRMechanismPlaceholder(IField mechDeclaration){
		super();
		deviceField = mechDeclaration;
